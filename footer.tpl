...
<!--                                <a class="dropdown-item" href="../siteweb.php">Site Web</a>-->
                    ...
                    <li class="li-page"><a href="../actu.php">Actualité</a></li><li class="li-page"><a href="../support.php">Support</a></li><li class="li-page"><a href="login.php">Espace client</a></li><li class="li-page"><a href="cart.php?a=view"><i class="fas fa-shopping-cart"></i></a></li>
